...
import com.example.wsaassignment.data.repoimpl.TrendingPageSourceImpl
...
abstract class RepositoryModule {
    ...
    @Singleton
    @Binds
    abstract fun bindTrendingMovieRepo( trendingRepo : TrendingPageSourceImpl) : TrendingSeriesPageSource
}